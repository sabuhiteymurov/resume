...
Nool LLC \hfill \textit{UAE, Remote}
 \begin{itemize}
    \itemsep -3pt {} 
        ...
        \item Utilized a range of technology stacks for the successful execution of the tasks, including Expo and its modules, i18next, detox for testing, react-native-maps, Nestjs, Fastify, Apollo GraphQl, RabbitMQ, Redis.
        \item Constructed a monolithic architecture for the backend using the Nx smart build system. Furthermore, I took the responsibility of creating the CI/CD pipeline. 
...
\vspace{-1.25em}
% \item \textbf{
%     Nool Agent Mobile App} {Nool Agent is an agenda app of Nool LLC, developed for drivers.
%     }
% \item \textbf{
%     Nool Customer Mobile App} { App mainly focused for customers.  
%     }
\item \textbf{
