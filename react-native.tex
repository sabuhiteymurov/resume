...
Libraries & React Navigation, Redux, Mapbox, OneSignal, RNFirebase, Socket.IO\\
APIs & RESTful, GraphQL\\
Payment Integration & Stripe, RevenueCat\\
DevOps & GitHub Actions, CI/CD, In-app updates\\
Testing & Jest, Detox, Playwright\\
Native Development & Creating native packages using Turbo Modules (JSI) or Nitro Modules\\
